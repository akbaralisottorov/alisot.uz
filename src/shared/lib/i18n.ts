...
export const translations = {
  uz: {
    ...
    newsletter: {
      ...
      periodicity: "📅 Davriylik: Har 14 kunda",
      guarantee: "🔒 Kafolat: Spam umuman yo'q",
      success_title: "Obuna muvaffaqiyatli yakunlandi!",
      success_desc: "Rahmat! Siz Akbarali Sottorovning marketing, brending va shaxsiy rivojlanish haqidagi tahlillariga muvaffaqiyatli obuna bo'ldingiz. Har ikki haftada yakshanba tongida xabarlarni pochtangizda kuting.",
      add_another: "Boshqa pochtani qo'shish",
      loading: "Yuklanmoqda...",
      error_invalid: "Iltimos, to'g'ri email manzilini kiriting.",
      error_generic: "Xatolik yuz berdi. Iltimos qaytadan urunib ko'ring.",
      error_network: "Tarmoqda xatolik yuz berdi. Ulanishni tekshiring."
    },
    notfound: {
  ...
  en: {
    ...
    newsletter: {
      ...
      cta: "Subscribe Now",
      periodicity: "📅 Frequency: Every 14 days",
      guarantee: "🔒 Guarantee: Zero spam",
      success_title: "Subscription successful!",
      success_desc: "Thank you! You have successfully subscribed to Akbarali Sottorov's analyses on marketing, branding, and personal development. Expect updates in your inbox every two weeks on Sunday mornings.",
      add_another: "Add another email",
      loading: "Loading...",
  ...
  ru: {
    ...
    newsletter: {
      ...
      periodicity: "📅 Периодичность: Каждые 14 дней",
      guarantee: "🔒 Гарантия: Без спама",
      success_title: "Подписка успешно завершена!",
      success_desc: "Спасибо! Вы успешно подписались на аналитику Акбарали Сотторова о маркетинге, брендинге и личном развитии. Ждите выпусков на вашей почте каждое воскресное утро раз в две недели.",
      add_another: "Добавить другую почту",
      loading: "Загрузка...",
      error_invalid: "Пожалуйста, введите корректный адрес электронной почты.",
      error_generic: "Произошла ошибка. Пожалуйста, попробуйте еще раз.",
      error_network: "Ошибка сети. Пожалуйста, проверьте подключение."
    },
    notfound: {
